  ...
  return (
    ...
    <div className='contact' id='contact'>
      ...
      <div className='contact-part'>
        ...
        <p><IoCall style={{marginTop:'2px'}} /><a href='/'>+91 6290807540</a></p>
          <p><HiOutlineMail style={{marginTop:'2px'}} /><a href="mailto:souravjana131@gmail.com" target='_blank'>souravjana131@gmail.com</a></p>
          <p><BsLinkedin style={{marginTop:'2px'}} /><a href="https://www.linkedin.com/in/souravjana131/" target='_blank'>linkedin.com/in/souravjana131</a></p>
          <p><AiFillGithub style={{marginTop:'2px'}} /><a href="https://github.com/sourav215" target='_blank'>github.com/sourav215</a></p>
        </div>
      </div>
